...
public class RecordSet {
    ...
    /**
     * Gets a string-based data view compatible with the legacy API; binary values are converted to Base64.
     *
     * @return A read-only string-based data view
     * @deprecated Use {@link #getAllValues()} instead, to get data that includes the original binary values
     */
    @Deprecated
    @ParametersAreNonnullByDefault
