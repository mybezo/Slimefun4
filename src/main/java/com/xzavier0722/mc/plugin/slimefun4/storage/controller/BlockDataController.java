 ...
 * <p>
 * Used to manage Slimefun Block data in chunks
 * <p>
...
public class BlockDataController extends ADataController {
    ...
    /**
     * Block inventory snapshot
     */
    private final Map<String, InvSnapshot> invSnapshots;
    /**
     * Global controller data loading lock
     *
     * {@link ScopedLock}
     */
    private final ScopedLock lock;
    /**
     * Delayed loading mode flag
     */
    ...
    /**
     * Load data for all worlds already loaded by the server
     */
    ...
    /**
     * Load data for all loaded chunks in all worlds already loaded by the server
     */
    ...
    /**
     * Initialize the delayed loading task
     *
     * @param p               Plugin instance
     * @param delayedSecond   Delay before the first execution
     * @param forceSavePeriod Forced save period
     */
    ...
    /**
     * Create a new Slimefun Block data at the specified location
     *
    ...
    /**
     * Create a new Slimefun universal data
     * <br/>
     * Provides a readable and writable KV storage Map
     *
     * @param sfId Slimefun item ID {@link SlimefunItem#getId()}
     * @return Universal data, {@link SlimefunUniversalData}
     */
    @Nonnull
     ...
     * Provides a readable and writable KV storage Map
     *
     * @param uuid Identifying UUID of the universal data
     * @param sfId Slimefun item ID {@link SlimefunItem#getId()}
     * @return Universal data, {@link SlimefunUniversalData}
     */
    @Nonnull
    ...
    /**
     * Create a new Slimefun universal Block data at the specified location
     *
     * @param l    Slimefun block location {@link Location}
     * @param sfId Slimefun item ID {@link SlimefunItem#getId()}
     * @return Universal Block data, {@link SlimefunUniversalBlockData}
     */
    @Nonnull
    ...
    /**
     * Immediately schedule saving a universal data
     *
     * @param universalData Universal data to be written and saved to the database
     */
    ...
    /**
     * Remove the Slimefun data at the specified location
     *
    ...
    /**
     * Remove the Slimefun Block data at the specified location
     *
     * @param l Location {@link Location}
     */
    ...
    /**
     * Remove the possible Slimefun universal Block data corresponding to the specified location
     *
    ...
    /**
     * Remove the Slimefun universal Block data corresponding to the specified UUID
     *
     * @param uuid Universal Block data identifier
     */
    ...
    /**
     * Get {@link SlimefunUniversalData} from the database
     */
    ...
    /**
     * Get {@link SlimefunUniversalData} from the cache
     *
    ...
    public void loadUniversalData(SlimefunUniversalData uniData) {
        ...
        // Build query conditions for universal data kv storage
    ...
    /**
     * Migrate old Slimefun machine data to universal data
     */
