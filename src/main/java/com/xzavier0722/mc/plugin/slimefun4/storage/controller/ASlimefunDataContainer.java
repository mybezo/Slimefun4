...
/**
 * Abstract class for Slimefun data containers.
 * <p>
 * This class is used to store Slimefun-specific data containers, including the Slimefun ID and a flag indicating whether it is pending deletion.
 *
 * @author NoRainCity
 *
 * @see ADataController
