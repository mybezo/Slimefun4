...
public class LocationUtils {
    /**
     * Converts a {@link Location} into the
     * standard-format location info used in the database
     *
    ...
    /**
     * Converts a {@link Chunk} into the
     * standard-format chunk info used in the database
     *
    ...
    /**
     * Converts a location into human-readable text
     *
     * Note: do not use this in the database conversion process!
     *
