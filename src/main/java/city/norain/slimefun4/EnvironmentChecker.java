...
class EnvironmentChecker {
    ...
    static boolean checkIncompatiblePlugins(@Nonnull Logger logger) {
        ...
        logger.log(Level.WARNING, "These plugins are listed here because they are no longer compatible with the current");
        logger.log(Level.WARNING, "Slimefun version or they conflict with Slimefun.");
        logger.log(Level.WARNING, "If you think these plugins can coexist with Slimefun,");
        logger.log(Level.WARNING, "please contact us so this can be updated.");
        logger.log(Level.WARNING, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        logger.log(Level.WARNING, "");
        printBorder(logger);
                ...
                .runTaskLater(
                        ...
                        () -> {
                            if (Bukkit.getPluginManager().getPlugin("SlimeGlue") == null) {
                                sf.getLogger().log(Level.WARNING, "SlimeGlue is not installed, some additional addon protection checks will be missing!");
