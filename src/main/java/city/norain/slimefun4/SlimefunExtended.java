...
public final class SlimefunExtended {
    ...
    /**
     * Returns the current server's Minecraft version details, including major, minor, and patch version numbers.
     * For example: 26.1.2 will return (26, 1, 2), and 26.1 will return (26, 1, 0).
     *
    ...
    public static ServerVersion getServerVerDetail(Server server) {
        ...
        // Extract the numeric parts of the version number
        String[] versionPart = mcVersion.split("\\.");

        // Could be a snapshot version or a pre-release?
        ...
        try {
            ...
            // Starting from 26.1, the Minecraft version format changed to use the year as the major version
