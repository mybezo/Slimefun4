...
public class EnvUtil {
    ...
    public void init() {
        try (var resource = Slimefun.class.getResourceAsStream("/git.properties")) {
            if (resource == null) {
                Slimefun.logger().warning("Could not load build information: /git.properties was not found");
                return;
            }
            ...
            Slimefun.logger().log(Level.WARNING, "Could not load build information", e);
        }
    }
