...
public final class WikiUtils {
    ...
    /**
     * Reads the addon's wiki.json and sets the item's Wiki button
     *
     * @param addon The {@link SlimefunAddon} instance
     */
    ...
    /**
     * Reads the addon's wiki.json and sets the item's Wiki button
     * Allows the page address to be modified
     *
     * @param plugin The {@link SlimefunAddon} instance
     * @param formatter Modifies the page address
     */
