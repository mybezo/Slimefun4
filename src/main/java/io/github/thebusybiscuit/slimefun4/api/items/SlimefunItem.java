...
public class SlimefunItem implements Placeable {
     ...
     *
     * Returns the unofficial Chinese Wiki address
     * Downstream code should use {@link SlimefunItem#addWikiPage(String)} to add a Wiki page
     *
     * @param page
    ...
    /**
     * Sets the Wiki page for this item
     *
     * @param page The item's Wiki page
     */
