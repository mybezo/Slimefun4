...
public class ProgrammableAndroid extends SlimefunItem
    ...
    protected void openScriptDownloader(Player p, SlimefunUniversalBlockData uniData, int page) {
        ChestMenu menu = new ChestMenu("Android Script");
        ...
        menu.addItem(
                48,
                new CustomItemStack(
                        HeadTexture.SCRIPT_UP.getAsItemStack(), "&eUpload Script", "", "&6Click &7to upload your current script", "&7to the server"));
        ...
        menu.addItem(53, new CustomItemStack(HeadTexture.SCRIPT_LEFT.getAsItemStack(), "&6> Back", "", "&7Return to the android control panel"));
    ...
    public void openScriptEditor(Player p, SlimefunUniversalBlockData uniData) {
        ...
        menu.addItem(
                3,
                new CustomItemStack(
                        HeadTexture.SCRIPT_NEW.getAsItemStack(), "&4> Create New Script", "", "&cDelete your current script", "&cand create a fresh blank script"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&eUse them as-is or edit them before use"));
        menu.addMenuClickHandler(5, (pl, slot, item, action) -> {
            openScriptDownloader(pl, uniData, 1);
            return false;
        });

        menu.addItem(8, new CustomItemStack(HeadTexture.SCRIPT_LEFT.getAsItemStack(), "&6> Back", "", "&7Return to the android control panel"));
