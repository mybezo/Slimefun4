...
abstract class AbstractEnchantmentMachine extends AContainer {
    ...
    protected void showEnchantmentLevelWarning(@Nonnull BlockMenu menu) {
        if (!useLevelLimit.getValue()) {
            throw new IllegalStateException("Auto Enchanter/Disenchanter level limits are not enabled, warning information cannot be displayed.");
        }
    ...
    protected void showEnchantmentLimitWarning(@Nonnull BlockMenu menu) {
        if (!useEnchantLimit.getValue()) {
            throw new IllegalStateException("Auto Enchanter/Disenchanter enchantment count limits are not enabled, warning information cannot be displayed.");
        }
